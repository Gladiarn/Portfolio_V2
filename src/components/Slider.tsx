  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center">
        <p
          className={`uppercase font-light transition-colors duration-300 tracking-widest leading-none ${labelClass} ${isActive ? "text-text-secondary" : "text-background"}`}
        >
          {leftLabel}
        </p>
      </div>
